...
<aside>
  Regardless of the chosen Machine Learning method, whether it's a traditional
  algorithm or a sophisticated technique like Convolutional Neural Networks, the
  most crucial aspect is its performance, which will be tested with new and
  unknown data.
</aside>
